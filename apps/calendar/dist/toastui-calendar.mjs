 ...
 * @version 2.0.4 | Fri Jul 29 2022
 * @author NHN Cloud FE Development Lab <dl_javascript@nhn.com>
 * @license MIT
 */
import DatePicker from "tui-date-picker";
var n$2, l$3, u$3, t$2, o$3, r$3, f$3, e$1 = {}, c$3 = [], s$3 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function a$3(n2, l2) {
  for (var u2 in l2)
    n2[u2] = l2[u2];
  return n2;
...
function m$2(n2) {
  (!n2.__d && (n2.__d = true) && t$2.push(n2) && !g$4.__r++ || r$3 !== l$3.debounceRendering) && ((r$3 = l$3.debounceRendering) || o$3)(g$4);
}
function g$4() {
  for (var n2; g$4.__r = t$2.length; )
    n2 = t$2.sort(function(n3, l2) {
      ...
      n3.__d && (o2 = (t2 = (l2 = n3).__v).__e, (r2 = l2.__P) && (u2 = [], (i2 = a$3({}, t2)).__v = t2.__v + 1, j$3(r2, t2, i2, l2.__n, r2.ownerSVGElement !== void 0, t2.__h != null ? [o2] : null, u2, o2 == null ? k$2(t2) : o2, t2.__h), z$2(u2, t2), t2.__e != o2 && b$2(t2)));
    });
}
function w$3(n2, l2, u2, i2, t2, o2, r2, f2, s2, a2) {
  ...
  for (u2.__e = m2, h2 = A2; h2--; )
    w2[h2] != null && (typeof u2.type == "function" && w2[h2].__e != null && w2[h2].__e == u2.__d && (u2.__d = k$2(i2, h2 + 1)), N(w2[h2], w2[h2]));
  if (g2)
...
function x$3(n2, l2, u2) {
  for (var i2, t2 = n2.__k, o2 = 0; t2 && o2 < t2.length; o2++)
    (i2 = t2[o2]) && (i2.__ = n2, l2 = typeof i2.type == "function" ? x$3(i2, l2, u2) : P$2(u2, i2, i2, t2, i2.__e, l2));
  return l2;
}
function A$2(n2, l2) {
...
function P$2(n2, l2, u2, i2, t2, o2) {
  var r2, f2, e2;
  if (l2.__d !== void 0)
...
function $$1(n2, l2, u2) {
  l2[0] === "-" ? n2.setProperty(l2, u2) : n2[l2] = u2 == null ? "" : typeof u2 != "number" || s$3.test(l2) ? u2 : u2 + "px";
}
  ...
  try {
    n:
      if (typeof $2 == "function") {
        if (m2 = u2.props, g2 = (s2 = $2.contextType) && t2[s2.__c], x2 = s2 ? g2 ? g2.props.value : s2.__ : t2, i2.__c ? b2 = (h2 = u2.__c = i2.__c).__ = h2.__E : ("prototype" in $2 && $2.prototype.render ? u2.__c = h2 = new $2(m2, x2) : (u2.__c = h2 = new _$3(m2, x2), h2.constructor = $2, h2.render = O$2), g2 && g2.sub(h2), h2.props = m2, h2.state || (h2.state = {}), h2.context = x2, h2.__n = t2, v2 = h2.__d = true, h2.__h = []), h2.__s == null && (h2.__s = h2.state), $2.getDerivedStateFromProps != null && (h2.__s == h2.state && (h2.__s = a$3({}, h2.__s)), a$3(h2.__s, $2.getDerivedStateFromProps(m2, h2.__s))), y2 = h2.props, p2 = h2.state, v2)
          ...
          if ($2.getDerivedStateFromProps == null && m2 !== y2 && h2.componentWillReceiveProps != null && h2.componentWillReceiveProps(m2, x2), !h2.__e && h2.shouldComponentUpdate != null && h2.shouldComponentUpdate(m2, h2.__s, x2) === false || u2.__v === i2.__v) {
        ...
        if (h2.context = x2, h2.props = m2, h2.__v = u2, h2.__P = n2, A2 = l$3.__r, P2 = 0, "prototype" in $2 && $2.prototype.render)
        ...
        h2.state = h2.__s, h2.getChildContext != null && (t2 = a$3(a$3({}, t2), h2.getChildContext())), v2 || h2.getSnapshotBeforeUpdate == null || (k2 = h2.getSnapshotBeforeUpdate(y2, p2)), C2 = s2 != null && s2.type === d$3 && s2.key == null ? s2.props.children : s2, w$3(n2, Array.isArray(C2) ? C2 : [C2], u2, i2, t2, o2, r2, f2, e2, c2), h2.base = u2.__e, u2.__h = null, h2.__h.length && f2.push(h2), b2 && (h2.__E = h2.__ = null), h2.__e = false;
      } else
...
function L$2(l2, u2, i2, t2, o2, r2, f2, c2) {
  ...
  if (d2 === null)
    ...
    if (r2 = r2 && n$2.call(l2.childNodes), a2 = (y2 = i2.props || e$1).dangerouslySetInnerHTML, v2 = p2.dangerouslySetInnerHTML, !c2) {
      if (r2 != null)
    ...
    if (C$1(l2, p2, y2, o2, c2), v2)
      u2.__k = [];
    else if (_2 = u2.props.children, w$3(l2, Array.isArray(_2) ? _2 : [_2], u2, i2, t2, o2 && d2 !== "foreignObject", r2, f2, r2 ? r2[0] : i2.__k && k$2(i2, 0), c2), r2 != null)
      for (_2 = r2.length; _2--; )
        r2[_2] != null && h$3(r2[_2]);
    c2 || ("value" in p2 && (_2 = p2.value) !== void 0 && (_2 !== l2.value || d2 === "progress" && !_2 || d2 === "option" && _2 !== y2.value) && H$2(l2, "value", _2, y2.value, false), "checked" in p2 && (_2 = p2.checked) !== void 0 && _2 !== l2.checked && H$2(l2, "checked", _2, y2.checked, false));
  }
  return l2;
}
...
function N(n2, u2, i2) {
  ...
  i2 || n2.__e == null || h$3(n2.__e), n2.__e = n2.__d = void 0;
}
...
function S$2(u2, i2, t2) {
  var o2, r2, f2;
  l$3.__ && l$3.__(u2, i2), r2 = (o2 = typeof t2 == "function") ? null : t2 && t2.__k || i2.__k, f2 = [], j$3(i2, u2 = (!o2 && t2 || i2).__k = v$3(d$3, null, [u2]), r2 || e$1, e$1, i2.ownerSVGElement !== void 0, !o2 && t2 ? [t2] : r2 ? null : i2.firstChild ? n$2.call(i2.childNodes) : null, f2, !o2 && t2 ? t2 : r2 ? r2.__e : i2.firstChild, o2), z$2(f2, u2);
}
function B$1(l2, u2, i2) {
  var t2, o2, r2, f2 = a$3({}, l2.props);
  for (r2 in u2)
    r2 == "key" ? t2 = u2[r2] : r2 == "ref" ? o2 = u2[r2] : f2[r2] = u2[r2];
  return arguments.length > 2 && (f2.children = arguments.length > 3 ? n$2.call(arguments, 2) : i2), y$2(l2.type, f2, t2 || l2.key, o2 || l2.ref, null);
}
function D$2(n2, l2) {
  var u2 = { __c: l2 = "__cC" + f$3++, __: n2, Consumer: function(n3, l3) {
...
n$2 = c$3.slice, l$3 = { __e: function(n2, l2, u2, i2) {
  ...
  throw n2;
} }, u$3 = 0, _$3.prototype.setState = function(n2, l2) {
  var u2;
  u2 = this.__s != null && this.__s !== this.state ? this.__s : this.__s = a$3({}, this.state), typeof n2 == "function" && (n2 = n2(a$3({}, u2), this.props)), n2 && a$3(u2, n2), n2 != null && this.__v && (l2 && this.__h.push(l2), m$2(this));
}, _$3.prototype.forceUpdate = function(n2) {
  this.__v && (this.__e = true, n2 && this.__h.push(n2), m$2(this));
}, _$3.prototype.render = d$3, t$2 = [], o$3 = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, g$4.__r = 0, f$3 = 0;
...
const templates = {
  milestone(model) {
    ...
    return /* @__PURE__ */ v$3(d$3, null, /* @__PURE__ */ v$3("span", {
  ...
  time(model) {
    ...
    if (start) {
      return /* @__PURE__ */ v$3("span", null, /* @__PURE__ */ v$3("strong", null, toFormat(start, "HH:mm")), "\xA0", /* @__PURE__ */ v$3("span", null, stripTags(title)));
    }
  ...
  weekDayName(model) {
    ...
    return /* @__PURE__ */ v$3(d$3, null, /* @__PURE__ */ v$3("span", {
      className: classDate
    }, model.date), "\xA0\xA0", /* @__PURE__ */ v$3("span", {
      className: className2
    }, model.dayName));
  },
...
function createStoreContext() {
  const StoreContext = D$2(null);
  function StoreProvider2({
    children,
    store
  }) {
    return v$3(StoreContext.Provider, { value: store, children });
  }
...
function Template({ template, param, as: tagName = "div" }) {
  ...
  return isString_1(htmlOrVnode) ? v$3(tagName, {
...
const EventBusContext = D$2(null);
...
function GridHeader({
  ...
  return /* @__PURE__ */ v$3("div", {
    ...
    style: { marginLeft }
  }, dayNames.map((dayName, index) => /* @__PURE__ */ v$3(DayName, {
    type,
...
const getDayGridEvents = (row, calendarData, { narrowWeekend, hourStart, hourEnd }) => {
  const panels = [
    {
      name: "milestone",
      type: "daygrid",
...
function getWeekDates(renderDate, { startDayOfWeek = Day$2.SUN, workweek }) {
  ...
  return range_1(startDayOfWeek, WEEK_DAYS + startDayOfWeek).reduce((acc, day) => {
...
function GridSelection$1({ type, gridSelectionData, weekDates, narrowWeekend }) {
  ...
  return width > 0 ? /* @__PURE__ */ v$3("div", {
...
function AlldayGridSelection({ weekDates, narrowWeekend }) {
  ...
  return /* @__PURE__ */ v$3(GridSelection$1, {
    type: "allday",
...
function g$1(n2, t2) {
  ...
  function r2(t3) {
    return this.shouldComponentUpdate = e2, v$3(n2, t3);
  }
  return r2.displayName = "Memo(" + (n2.displayName || n2.name) + ")", r2.prototype.isReactComponent = true, r2.__f = true, r2;
}
(E.prototype = new _$3()).isPureReactComponent = true, E.prototype.shouldComponentUpdate = function(n2, t2) {
...
l$3.unmount = function(n2) {
...
}, (L.prototype = new _$3()).__c = function(n2, t2) {
  ...
  var u2 = t2.__e && v$3(d$3, null, n2.fallback);
  return u2 && (u2.__h = null), [v$3(d$3, null, t2.__e ? null : n2.children), u2];
};
...
function I(n2) {
  ...
  } }), S$2(v$3(D, { context: t2.context }, n2.__v), t2.l)) : t2.l && t2.componentWillUnmount();
}
function W(n2, t2) {
  var e2 = v$3(I, { __v: n2, i: t2 });
  return e2.containerInfo = t2, e2;
}
(M.prototype = new _$3()).__e = function(n2) {
...
_$3.prototype.isReactComponent = {}, ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function(n2) {
  Object.defineProperty(_$3.prototype, n2, { configurable: true, get: function() {
...
function ExceedCount({ index, exceedCount, isClicked, onClickExceedCount }) {
  ...
  return exceedCount && !isClicked ? /* @__PURE__ */ v$3("span", {
...
function CollapseButton({ isClicked, isClickedIndex, onClickCollapseButton }) {
  return isClicked && isClickedIndex ? /* @__PURE__ */ v$3("span", {
    className: cls("weekday-exceed-in-week"),
...
function GridCell$1({
  ...
  return /* @__PURE__ */ v$3("div", {
    ...
    style
  }, /* @__PURE__ */ v$3(ExceedCount, {
    index,
    exceedCount,
    isClicked,
    onClickExceedCount
  }), /* @__PURE__ */ v$3(CollapseButton, {
    isClickedIndex,
    isClicked,
    onClickCollapseButton
  }));
...
const GridCells = g$1(function GridCells2({
  ...
  return /* @__PURE__ */ v$3(d$3, null, weekDates.map((cell, index) => {
    ...
    return /* @__PURE__ */ v$3(GridCell$1, {
...
const LayoutContainerContext = D$2(null);
...
function useAlldayGridRowEventMove({ rowStyleInfo, gridPositionFinder }) {
  ...
  const targetEventStartGridX = F$1(() => isNil(movingEvent) ? null : rowStyleInfo.findIndex(({ left }) => left === movingEvent.left), [rowStyleInfo, movingEvent]);
  const currentMovingLeft = F$1(() => {
...
function MovingEventShadow$2({
  ...
  return /* @__PURE__ */ v$3(HorizontalEvent, {
    uiModel: movingEvent,
...
function AlldayGridRow({
  ...
  const maxTop = F$1(() => Math.max(0, ...events.map(({ top }) => top)), [events]);
  const gridPositionFinder = F$1(() => createGridPositionFinder({
  ...
  const horizontalEvents = F$1(() => events.filter(isWithinHeight(height, EVENT_HEIGHT + WEEK_EVENT_MARGIN_TOP)).map((uiModel) => /* @__PURE__ */ v$3(HorizontalEvent, {
  ...
  return /* @__PURE__ */ v$3(d$3, null, /* @__PURE__ */ v$3("div", {
  ...
  }, horizontalEvents), /* @__PURE__ */ v$3(ResizingEventShadow, {
    weekDates,
    gridPositionFinder,
    gridColWidthMap
  }), /* @__PURE__ */ v$3(MovingEventShadow$2, {
    rowStyleInfo,
    gridPositionFinder
  }), /* @__PURE__ */ v$3(AlldayGridSelection, {
    weekDates,
    narrowWeekend
  })));
}
...
function EventDetailSectionDetail({ event }) {
  ...
  return /* @__PURE__ */ v$3("div", {
    ...
    param: event,
    as: "span"
  }))), recurrenceRule && /* @__PURE__ */ v$3("div", {
    className: classNames$j.detailItem
  }, /* @__PURE__ */ v$3("span", {
    ...
    className: classNames$j.content
  }, (_b = calendar == null ? void 0 : calendar.name) != null ? _b : "")), body && /* @__PURE__ */ v$3("div", {
...
const FloatingLayerContext = D$2(null);
function FloatingLayerProvider({ children }) {
  ...
  return /* @__PURE__ */ v$3(FloatingLayerContext.Provider, {
    value: floatingLayer
  }, children, /* @__PURE__ */ v$3("div", {
...
function EventDetailPopup() {
  ...
  }, /* @__PURE__ */ v$3(EventDetailSectionHeader, {
    event
  }), /* @__PURE__ */ v$3(EventDetailSectionDetail, {
    event
  }), !isReadOnly && /* @__PURE__ */ v$3("div", {
...
function CalendarDropdownMenu({ calendars, setOpened, onChangeIndex }) {
  ...
  return /* @__PURE__ */ v$3("ul", {
    className: classNames$g.dropdownMenu
  }, calendars.map(({ name, backgroundColor = "000" }, index) => /* @__PURE__ */ v$3(DropdownMenuItem, {
...
function CalendarSelector({ calendars, selectedCalendarId, formStateDispatch }) {
  ...
  return /* @__PURE__ */ v$3(PopupSection, {
  ...
  }, name), /* @__PURE__ */ v$3("span", {
    className: cls("icon", "ic-dropdown-arrow", { open: isOpened })
  })), isOpened && /* @__PURE__ */ v$3(CalendarDropdownMenu, {
    calendars,
    setOpened,
...
function ClosePopupButton({ type, close }) {
  ...
  }, type === "moreEvents" ? /* @__PURE__ */ v$3(Template, {
...
function ConfirmPopupButton({ children }) {
  ...
  }, /* @__PURE__ */ v$3("span", null, children));
}
...
const DateSelector = x$1(function DateSelector2({ start, end, isAllday: isAllday2 = false, formStateDispatch }, ref) {
  ...
  return /* @__PURE__ */ v$3(PopupSection, null, /* @__PURE__ */ v$3("div", {
...
function StateDropdownMenu({ setOpened, setEventState }) {
  ...
  }, EVENT_STATES.map((state) => /* @__PURE__ */ v$3("li", {
    key: state,
  ...
  }, state === "Busy" ? /* @__PURE__ */ v$3(Template, {
...
function EventStateSelector({ eventState = "Busy", formStateDispatch }) {
  ...
  }, eventState === "Busy" ? /* @__PURE__ */ v$3(Template, {
    template: "popupStateBusy"
  }) : /* @__PURE__ */ v$3(Template, {
    template: "popupStateFree"
  })), /* @__PURE__ */ v$3("span", {
    className: classNames$a.arrowIcon
  })), isOpened && /* @__PURE__ */ v$3(StateDropdownMenu, {
    setOpened,
...
function EventFormPopup() {
  ...
  }, (calendars == null ? void 0 : calendars.length) ? /* @__PURE__ */ v$3(CalendarSelector, {
    selectedCalendarId: formState.calendarId,
    calendars,
    formStateDispatch
  }) : /* @__PURE__ */ v$3(PopupSection, null), /* @__PURE__ */ v$3(TitleInputBox, {
    title,
    isPrivate: formState.isPrivate,
    formStateDispatch
  }), /* @__PURE__ */ v$3(LocationInputBox, {
    location: location2
  }), /* @__PURE__ */ v$3(DateSelector, {
    start,
    end,
    isAllday: formState.isAllday,
    formStateDispatch,
    ref: datePickerRef
  }), /* @__PURE__ */ v$3(EventStateSelector, {
    eventState: formState.state,
    formStateDispatch
  }), /* @__PURE__ */ v$3(ClosePopupButton, {
    type: "form",
    close
  }), /* @__PURE__ */ v$3(PopupSection, null, /* @__PURE__ */ v$3(ConfirmPopupButton, null, isCreationPopup ? /* @__PURE__ */ v$3(Template, {
    template: "popupSave"
  }) : /* @__PURE__ */ v$3(Template, {
...
function SeeMoreEventsPopup() {
  ...
  }, events.map((uiModel) => /* @__PURE__ */ v$3(HorizontalEvent, {
...
function Layout({
  ...
  const layoutClassName = F$1(() => `${cls("layout")} ${className2}`, [className2]);
  h$2(() => {
    if (container) {
  ...
  return /* @__PURE__ */ v$3(LayoutContainerProvider, {
    value: container
  }, /* @__PURE__ */ v$3("div", {
    ref: containerRefCallback,
    className: layoutClassName,
    style: __spreadProps(__spreadValues({}, getLayoutStylesFromInfo(width, height)), { backgroundColor })
  }, container ? children : null), /* @__PURE__ */ v$3(EventFormPopup, null), /* @__PURE__ */ v$3(EventDetailPopup, null), /* @__PURE__ */ v$3(SeeMoreEventsPopup, null), /* @__PURE__ */ v$3(PopupOverlay, null));
}
...
const Panel = x$1(function Panel2({
  name,
  ...
  return /* @__PURE__ */ v$3(d$3, null, /* @__PURE__ */ v$3("div", {
    ...
    style: styles,
    ref
  }, children), isResizable ? /* @__PURE__ */ v$3(PanelResizer, {
    name,
    width: resizerWidth,
...
function TimeEvent({
  ...
  })) : null, comingDurationHeight ? /* @__PURE__ */ v$3("div", {
    className: classNames$5.travelTime,
    style: comingDurationStyle
  }, /* @__PURE__ */ v$3(Template, {
    template: "comingDuration",
    param: model
  })) : null, shouldShowResizeHandle ? /* @__PURE__ */ v$3("div", {
...
function GridSelection({ top, height, text }) {
  ...
  }, text.length > 0 ? /* @__PURE__ */ v$3("span", {
...
function GridSelectionByColumn({ columnIndex, timeGridRows }) {
  ...
  return /* @__PURE__ */ v$3(GridSelection, __spreadValues({}, gridSelectionProps));
}
function useTimeGridEventResize({
  ...
  const oneRowHeight = F$1(() => baseResizingInfo ? timeGridData.rows[0].height : 0, [baseResizingInfo, timeGridData.rows]);
  _$2(() => {
...
function VerticalEvents({
  ...
  return /* @__PURE__ */ v$3("div", {
    ...
    style
  }, eventUIModels.map((eventUIModel) => /* @__PURE__ */ v$3(TimeEvent, {
...
const Column = g$1(function Column2({
  ...
  }, /* @__PURE__ */ v$3(VerticalEvents, {
    eventUIModels: uiModelsByColumn,
    minEventHeight
  }), /* @__PURE__ */ v$3(ResizingGuideByColumn, {
    gridPositionFinder,
    totalUIModels,
    columnIndex,
    timeGridData
  }), /* @__PURE__ */ v$3(GridSelectionByColumn, {
    columnIndex,
    timeGridRows
  }));
});
...
function NowIndicatorLabel({ unit, top, now, zonedNow }) {
  ...
  }, dateDifference !== 0 && /* @__PURE__ */ v$3("span", {
    className: cls(classNames$2.dayDifference)
  }, `[${dateDifference > 0 ? "+" : "-"}${Math.abs(dateDifference)}]`), /* @__PURE__ */ v$3(Template, {
...
function HourRows({ rowsInfo, isPrimary, borderRight, width, nowIndicatorState }) {
  ...
  }), showNowIndicator && isPresent(nowIndicatorState) && isPresent(zonedNow) && /* @__PURE__ */ v$3(NowIndicatorLabel, {
    unit: "hour",
...
const TimeColumn = g$1(function TimeColumn2({ timeGridRows, nowIndicatorState }) {
  ...
  const rowsByHour = F$1(() => timeGridRows.filter((_2, index) => index % 2 === 0 || index === timeGridRows.length - 1), [timeGridRows]);
  ...
  const otherTimezoneHourRowsProps = F$1(() => {
  ...
  }, !timezonesCollapsed && otherTimezoneHourRowsProps.map((rowsInfo) => /* @__PURE__ */ v$3(HourRows, {
...
function TimeGrid({ timeGridData, events }) {
  ...
  }, /* @__PURE__ */ v$3(GridLines, {
    timeGridRows: rows
  }), /* @__PURE__ */ v$3(MovingEventShadow$1, {
    gridPositionFinder,
    timeGridData
  }), columns.map((column, index) => /* @__PURE__ */ v$3(Column, {
  ...
  })), showNowIndicator && isPresent(currentDateData) && isPresent(nowIndicatorState) ? /* @__PURE__ */ v$3(NowIndicator, {
    top: nowIndicatorState.top,
...
function TimezoneLabels({ top }) {
  ...
  return /* @__PURE__ */ v$3("div", {
    ...
    var _a;
    return /* @__PURE__ */ v$3(TimezoneLabel, __spreadValues({
      key: `subTimezone-${(_a = subTimezone.label) != null ? _a : subTimezone.offset}`,
      width: timezoneLabelWidth,
      left: timezoneLabelWidth * index
    }, subTimezone));
  }), showTimezoneCollapseButton && /* @__PURE__ */ v$3(TimezoneCollapseButton, {
    isCollapsed: timezonesCollapsed
  }), /* @__PURE__ */ v$3(TimezoneLabel, __spreadValues({
    width: timezoneLabelWidth,
...
function useCalendarData(calendar, ...filters) {
  const filteredEvents = F$1(() => calendar.events.filter(Collection.and(...filters)), [calendar.events, filters]);
  const filteredEventsWithTimezone = useEventsWithTimezone(filteredEvents);
  return F$1(() => __spreadProps(__spreadValues({}, calendar), {
...
function Day$1() {
  ...
  const days = F$1(() => [renderDate], [renderDate]);
  ...
  const timeGridData = F$1(() => createTimeGridData(days, {
    hourStart,
    hourEnd,
    narrowWeekend
  ...
  const gridRows = activePanels.map((key) => {
    ...
    const rowType = key;
    return /* @__PURE__ */ v$3(Panel, {
      key: rowType,
      name: rowType,
      resizable: rowType !== lastPanelType
    }, rowType === "allday" ? /* @__PURE__ */ v$3(AlldayGridRow, {
  ...
  }, /* @__PURE__ */ v$3(GridHeader, {
    type: "week",
    dayNames,
    marginLeft: gridHeaderMarginLeft,
    rowStyleInfo
  })), gridRows, activePanels.includes("time") ? /* @__PURE__ */ v$3(Panel, {
    name: "time",
    autoSize: 1,
    ref: setTimePanelRef
  }, /* @__PURE__ */ v$3(TimeGrid, {
    events: dayGridEvents.time,
    timeGridData
  }), /* @__PURE__ */ v$3(TimezoneLabels, {
    top: stickyTop
  })) : null);
}
function AccumulatedGridSelection({ rowIndex, weekDates, narrowWeekend }) {
  ...
  }, gridSelectionDataByRow.map((gridSelectionData) => gridSelectionData ? /* @__PURE__ */ v$3(GridSelection$1, {
    type: "accumulated",
    gridSelectionData,
    weekDates,
    narrowWeekend
...
function useCellHeaderTheme() {
  ...
  return F$1(() => ({ common, month }), [common, month]);
}
function CellHeader({
  ...
  return /* @__PURE__ */ v$3("div", {
    ...
    param: templateParam
  })), exceedCount ? /* @__PURE__ */ v$3(MoreEventsButton, {
    type,
    number: exceedCount,
...
const MonthEvents = g$1(function MonthEvents2({
  ...
  const dayEvents = events.filter(isWithinHeight(contentAreaHeight, eventHeight + MONTH_EVENT_MARGIN_TOP)).map((uiModel) => /* @__PURE__ */ v$3(HorizontalEvent, {
...
function DayGridMonth({ dateMatrix = [], rowInfo = [], cellWidthMap = [] }) {
  ...
  const renderedEventUIModels = F$1(() => dateMatrix.map((week) => getRenderedEventUIModels(week, calendarData, narrowWeekend)), [calendarData, dateMatrix, narrowWeekend]);
  const onMouseDown = useGridSelection({
    type: "dayGridMonth",
    gridPositionFinder,
  ...
  return /* @__PURE__ */ v$3("div", {
    ...
    }, /* @__PURE__ */ v$3(GridRow, {
      gridDateEventModelMap,
      week,
      rowInfo,
      contentAreaHeight: cellContentAreaHeight
    }), /* @__PURE__ */ v$3(MonthEvents, {
      name: "month",
      events: uiModels,
      contentAreaHeight: cellContentAreaHeight,
      eventHeight: MONTH_EVENT_HEIGHT,
      className: cls("weekday-events")
    }), /* @__PURE__ */ v$3(GridSelectionByRow, {
      weekDates: week,
      narrowWeekend,
      rowIndex
    }), /* @__PURE__ */ v$3(AccumulatedGridSelection, {
      rowIndex,
      weekDates: week,
      narrowWeekend
    })), /* @__PURE__ */ v$3(ResizingGuideByRow, {
      dateMatrix,
      gridPositionFinder,
      rowIndex,
      cellWidthMap,
      renderedUIModels: renderedEventUIModels
    }), /* @__PURE__ */ v$3(MovingEventShadow, {
      dateMatrix,
      gridPositionFinder,
      rowIndex,
      rowInfo
...
function Month$1() {
  ...
  const dateMatrix = F$1(() => createDateMatrixOfMonth(renderDate, monthOptions), [monthOptions, renderDate]);
  const { rowStyleInfo, cellWidthMap } = F$1(() => getRowStyleInfo(dayNames.length, narrowWeekend, startDayOfWeek, workweek), [dayNames.length, narrowWeekend, startDayOfWeek, workweek]);
...
function Week$1() {
  ...
  const weekOptions = options.week;
  const { narrowWeekend, startDayOfWeek, workweek, hourStart, hourEnd, eventView, taskView } = weekOptions;
  const weekDates = F$1(() => getWeekDates(renderDate, weekOptions), [renderDate, weekOptions]);
  ...
  const calendarData = useCalendarData(calendar, options.eventFilter);
  const eventByPanel = F$1(() => getDayGridEvents(weekDates, calendarData, {
    narrowWeekend,
    hourStart,
    hourEnd
  }), [calendarData, hourEnd, hourStart, narrowWeekend, weekDates]);
  const timeGridData = F$1(() => createTimeGridData(weekDates, {
    hourStart,
    hourEnd,
    narrowWeekend
  ...
  const hasTimePanel = F$1(() => activePanels.includes("time"), [activePanels]);
  useTimeGridScrollSync(timePanel, timeGridData.rows.length);
  const stickyTop = useTimezoneLabelsTop(timePanel);
  return /* @__PURE__ */ v$3(Layout, {
    ...
    options: weekOptions,
    rowStyleInfo
  })), dayGridRows, hasTimePanel ? /* @__PURE__ */ v$3(Panel, {
    name: "time",
    autoSize: 1,
    ref: setTimePanelRef
  }, /* @__PURE__ */ v$3(TimeGrid, {
...
function Main() {
  const { currentView } = useStore(viewSelector);
  const CurrentViewComponent = F$1(() => views[currentView] || (() => null), [currentView]);
  return /* @__PURE__ */ v$3(CurrentViewComponent, null);
}
...
function x(r2, n2, l2, c2, g2, h2) {
  ...
  var w2, k2 = r2.type, O2 = r2.props, C2 = false;
  if (typeof k2 == "function") {
    if (C2 = true, !l2.shallow || !c2 && l2.renderRootComponent !== false) {
      ...
      if (k2.prototype && typeof k2.prototype.render == "function") {
        var M2 = k2.contextType, T2 = M2 && n2[M2.__c], $2 = M2 != null ? T2 ? T2.props.value : M2.__ : n2;
        (j2 = r2.__c = new k2(O2, $2)).__v = r2, j2._dirty = j2.__d = true, j2.props = O2, j2.state == null && (j2.state = {}), j2._nextState == null && j2.__s == null && (j2._nextState = j2.__s = j2.state), j2.context = $2, k2.getDerivedStateFromProps ? j2.state = f(f({}, j2.state), k2.getDerivedStateFromProps(j2.props, j2.state)) : j2.componentWillMount && (j2.componentWillMount(), j2.state = j2._nextState !== j2.state ? j2._nextState : j2.__s !== j2.state ? j2.__s : j2.state), F2 && F2(r2), H2 = j2.render(j2.props, j2.state, j2.context);
      } else
        for (var L2 = k2.contextType, E2 = L2 && n2[L2.__c], D2 = L2 != null ? E2 ? E2.props.value : L2.__ : n2, N2 = 0; j2.__d && N2++ < 25; )
          j2.__d = false, F2 && F2(r2), H2 = k2.call(r2.__c, O2, D2);
      ...
      if (z2 !== "children") {
        if (!d.test(z2) && (l2 && l2.allAttributes || z2 !== "key" && z2 !== "ref" && z2 !== "__self" && z2 !== "__source")) {
          if (z2 === "defaultValue")
            ...
            g2 && z2.match(/^xlink:?./) && (z2 = z2.toLowerCase().replace(/^xlink:?/, "xlink:"));
          if (z2 === "htmlFor") {
            if (O2.for)
              continue;
            z2 = "for";
          ...
          if (V2 || V2 === "")
            ...
            if (z2 === "value") {
              ...
              k2 === "option" && h2 == I2 && O2.selected === void 0 && (U2 += " selected");
            }
            U2 += " " + z2 + '="' + o(I2) + '"';
          }
        }
  ...
  if (U2 += ">", d.test(k2))
    throw new Error(k2 + " is not a valid HTML tag name in " + U2);
  var B2, G2 = _.test(k2) || l2.voidElements && l2.voidElements.test(k2), J2 = [];
  if (R2)
    m2 && i(R2) && (R2 = "\n" + y2 + a(R2, y2)), U2 += R2;
    ...
    for (var K2 = m2 && ~U2.indexOf("\n"), Q2 = false, X2 = 0; X2 < B2.length; X2++) {
      var Y2 = B2[X2];
      if (Y2 != null && Y2 !== false) {
        var ee = x(Y2, n2, l2, true, k2 === "svg" || k2 !== "foreignObject" && g2, h2);
...
function CalendarContainer({ theme, store, eventBus, children }) {
  return /* @__PURE__ */ v$3(EventBusProvider, {
    value: eventBus
  }, /* @__PURE__ */ v$3(ThemeProvider, {
    store: theme
  }, /* @__PURE__ */ v$3(StoreProvider, {
    store
  }, /* @__PURE__ */ v$3(FloatingLayerProvider, null, children))));
}
...
class CalendarCore {
  ...
  render() {
    if (isPresent(this.container)) {
      S$2(/* @__PURE__ */ v$3(CalendarContainer, {
        theme: this.theme,
        store: this.store,
  ...
  renderToString() {
    return m(/* @__PURE__ */ v$3(CalendarContainer, {
      theme: this.theme,
      store: this.store,
      eventBus: this.eventBus
    }, this.getComponent()));
...
class Day extends CalendarCore {
  ...
  getComponent() {
    return /* @__PURE__ */ v$3(Day$1, null);
  }
}
class Month extends CalendarCore {
  ...
  getComponent() {
    return /* @__PURE__ */ v$3(Month$1, null);
  }
  hideMoreView() {
...
class Week extends CalendarCore {
  ...
  getComponent() {
    return /* @__PURE__ */ v$3(Week$1, null);
  }
}
